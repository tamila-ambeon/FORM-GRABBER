...
<p><span class="badge bg-info">Крок 4 з X</span> Створи новий .js файл який буде розширювати клас і стане обробником кнопки. Шлях до файлу має співпадати з роутом. Дай назву класу таку, щоб це відображало суть форми. І обов'язково вкажи <b>кнопку-заглушку для очікування запиту</b>. Це потрібно, щоб не було випадкових подвійних кліків.</p>
