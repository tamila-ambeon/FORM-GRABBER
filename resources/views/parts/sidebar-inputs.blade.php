<div class="sb pt-4 pb-4 border-end">
    ...
    <div class="sb-title">Вибір:</div>
        ...
        <div class="sb-item"><a class="sb-link" href="{{URL::to('/')}}/inputs/radio">Radio</a></div>
        <div class="sb-item"><a class="sb-link" href="{{URL::to('/')}}/inputs/checkbox">Checkbox</a></div>
    ...
    <div class="sb-title">TODO:</div>
        ...
        <div class="sb-item">Range</div>
        <div class="sb-item">Password</div>
